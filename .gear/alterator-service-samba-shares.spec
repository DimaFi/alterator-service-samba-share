...
install -p -D -m644 src/%service.service %buildroot%_alterator_datadir/service/%service.service
...
%changelog
* Tue Jul 26 2025 Dmitry Filippenko <dmitfilippenko@yandex.ru> 0.1.1-alt1
- Initial commit
